"""
Django settings for api_with_drf project.
...
SECRET_KEY = 'django-insecure-5yza$-t7m_b42=cn-663nkg+9e6b%&@i=)k#$+krfwreug2y0^'
...
WSGI_APPLICATION = 'api_with_drf.wsgi.application'
